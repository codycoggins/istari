...
## Current Status
- **Phases 1–8d complete** — ReAct agent, memory, Eisenhower matrix, MCP integration, security hardening, projects with full UI, proactive project staleness, deadlines + recurrence; **382 backend + 34 frontend tests passing**, no exclusions, ruff clean
