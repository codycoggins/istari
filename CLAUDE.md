...
## Current Status
- **Phases 1–7 complete + Phase 8a (Projects layer) complete** — ReAct agent, memory, Eisenhower matrix, MCP integration, security hardening, projects; **363 backend + 21 frontend tests passing**, no exclusions, ruff clean
