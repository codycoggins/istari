...
## Current Status
- **Phases 1–9a complete** — ReAct agent, memory, Eisenhower matrix, MCP integration, security hardening, projects with full UI, proactive project staleness, cross-client chat history; **367 backend + 38 frontend tests passing**, no exclusions, ruff clean
