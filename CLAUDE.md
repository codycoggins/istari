...
See `AVAILABLE_CLI_TOOLS.md` for CLI tools available on this machine (eza, bat, fd, fzf, zoxide, pgcli, lazygit, lazydocker, httpie, yq, delta, etc.) — prefer these over basic alternatives when running shell commands.
